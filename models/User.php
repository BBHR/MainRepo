...
class User extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    {
        return [
            [['user_surname', 'user_name', 'user_email', 'user_password', 'user_signup_at','user_phone_number'], 'required'],
            ...
            [['user_phone_number'], 'match', 'pattern' => '#^\d{10,11}$#'],
//            [['user_signup_at', 'user_signin_at'], 'safe'],
    ...
    public function createAuthKey() {
        return $this->auth_key =Yii::$app->security->generateRandomString(32);
    }
    ...
    {
//        var_dump([\Yii::$app->security->generatePasswordHash($password),$this->user_password]);
